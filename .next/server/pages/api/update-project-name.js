...
module.exports = __webpack_require__("1DUi");
...
/* harmony default export */ __webpack_exports__["default"] = (async (request, response) => {
  ...
  try {
    await _middleware_models_router__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].updateOne({
      _id
    }, {
      $set: {
        project
    ...
    return response.status(500).json({
      success: false,
      message: 'failed to update a project name'
    });
  }
});
