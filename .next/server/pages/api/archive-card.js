...
module.exports = __webpack_require__("dYq+");
...
/* harmony default export */ __webpack_exports__["default"] = (async (request, response) => {
  ...
  try {
    const column = await _middleware_models_column__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOne({
      projectId,
      category: 'archive'
    });
    await _middleware_models_card__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].updateOne({
      _id
    }, {
      $set: {
