...
module.exports = __webpack_require__("uTN2");
...
/* harmony default export */ __webpack_exports__["default"] = (async (request, response) => {
  ...
  try {
    await _middleware_models_checklist__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].deleteOne({
      _id
    });
    ...
    return response.status(500).json({
      success: false,
      message: 'failed to delete a checklist'
    });
  }
});
