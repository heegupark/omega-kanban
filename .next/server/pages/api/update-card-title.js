...
module.exports = __webpack_require__("ebfT");
...
/* harmony default export */ __webpack_exports__["default"] = (async (request, response) => {
  ...
  try {
    await _middleware_models_card__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].updateOne({
      _id
    }, {
      $set: {
        cardTitle
    ...
    return response.status(500).json({
      success: false,
      message: 'failed to update a card title'
    });
  }
});
